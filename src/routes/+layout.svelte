<script lang="ts">
  ...
  import { House, FolderOpen, Clock, Receipt, Users, Plus, CheckSquare } from 'phosphor-svelte';
...
<div class="min-h-screen bg-paper">
  ...
  <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-ink/10 px-4 pb-safe z-50">
